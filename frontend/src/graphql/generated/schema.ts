...
export type AddCountryMutation = { __typename?: 'Mutation', addCountry: { __typename?: 'Country', id: number, name: string, code: string, emoji: string, continent?: { __typename?: 'Continent', id: number, name: string } | null } };
...
export type CountryQuery = { __typename?: 'Query', country: { __typename?: 'Country', id: number, name: string, code: string, emoji: string, continent?: { __typename?: 'Continent', id: number, name: string } | null } };
